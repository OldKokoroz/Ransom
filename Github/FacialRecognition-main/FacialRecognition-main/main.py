    ...
    def run_recognition(self):
        ...
        while True:
            ...
            if self.process_current_frame:
                ...
                for face_encoding in self.face_encodings:
                    ...
                    if matches[best_match_index]:
                        ...
                        name = name.split(".")[0]
                        confidence = face_conf(face_distances[best_match_index])
            ...
            for (top, right, bottom, left), name in zip(reversed(self.face_locations), reversed(self.face_names)):
                ...
                cv2.putText(frame, name, (left + 6, bottom - 6), cv2.FONT_ITALIC, 0.8, (0, 0, 255), 1)

            cv2.imshow("CHINESE FREEDOM", frame)
